...
"""We cache the to speed up future access. """
...
def predictAndEvaluate(bestModel, label, testDf, rfEvaluator, nrFilteredDf):
    try:
...
def main():
    ...
    predictAndEvaluate(bestModel, label, testSplit, rfEvaluator, nrFilteredDf)
